...
void			fdf_draw_pixel(t_fdf_renderer *render,
					t_vec2 pos, t_fdf_color color);
void			fdf_draw_segment(t_fdf_renderer *render,
...
void			fdf_draw_segment_quality(t_fdf_renderer *render,
					t_vec2 p[2], t_fdf_shader shader, void *data);
void			fdf_draw_rect(t_fdf_renderer *render,
					t_vec2 s[2], t_fdf_color color);
